...
void imagkjz_RGB::linilzatfeture_space()
{
 ...
 for(Pix_id=0; Pix_id<raw_img_rgb_vec.size(),i++)
    ...
    image_intcity_struc.img_colour_intisity_double[Pix_id+1]= reinterpret_cast<double>(Pix_id+1);
    image_intcity_struc.img_colour_intisity_double[Pix_id+2]= reinterpret_cast<double>(Pix_id+2);
